<h1 align="center">React Native Stepper Tour</h1>

<div align="center">
  <p align="center">
    <a href="https://github.com/mohebifar/react-native-stepper-tour/actions/workflows/release.yml">
      <img src="https://img.shields.io/github/actions/workflow/status/mohebifar/react-native-stepper-tour/release.yml?branch=master&style=flat-square" alt="Build Status" />
    </a>
    <a href="https://www.npmjs.com/package/react-native-stepper-tour">
      <img src="https://img.shields.io/npm/v/react-native-stepper-tour.svg?style=flat-square" alt="NPM Version" />
    </a>
    <a href="https://www.npmjs.com/package/react-native-stepper-tour">
      <img src="https://img.shields.io/npm/dm/react-native-stepper-tour.svg?style=flat-square" alt="NPM Downloads" />
    </a>
  </p>
</div>
...
```
yarn add react-native-stepper-tour

# or with npm:

npm install --save react-native-stepper-tour
```
...
```js
import { CopilotProvider } from "react-native-stepper-tour";
...
If you are looking for a working example, please check out [this link](https://github.com/mohebifar/react-native-stepper-tour/blob/master/example/App.js).

### Overlays and animation

The overlay in react-native-stepper-tour is the component that draws the dark transparent over the screen. react-native-stepper-tour comes with two overlay options: `view` and `svg`.
...
```js
import { CopilotStep } from "react-native-stepper-tour";
...
- `stepChange` — Next step is triggered. Passes [`Step`](https://github.com/mohebifar/react-native-stepper-tour/blob/master/src/types.js#L2) instance as event handler argument.

**Example:**

```js
import { useCopilot } from "react-native-stepper-tour";
